...
first 4h
i start sherching parameters for that engine what i know becuse engine need to be fit good i dont wanna to engine feel out when we flying
when i have all i start with make all engine location idk what its name . this need be symetric for drone to dont shake
i have photo on pc . pc is in repir
